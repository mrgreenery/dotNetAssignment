...
{ 
    private readonly string _filePath = "comments.json";  //define the file path
    ...
    public async Task<Comment> AddAsync(Comment comment) 
    {
        ...
        await File.WriteAllTextAsync(_filePath, commentsAsJson); //write the jason back to the file
